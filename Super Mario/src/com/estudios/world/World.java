...
import com.estudios.entities.Coin;
				...
				for (int yy = 0; yy < map.getHeight(); yy++) {
					...
					if (pixelAtual == 0xFF000000) {
						...
						if (yy-1 >= 0 && pixels[xx + ((yy - 1) * map.getWidth())] == 0xFFffffff) {
							tiles[xx + (yy * WIDTH)] = new WallTile(xx * 16, yy * 16, Tile.TILE_LAMA);
						}
						...
						// Enemy
						Enemy e = new Enemy(xx*16, yy*16, 16,16,1, Entity.ENEMY_SPRITE1[0]);
						Game.entities.add(e);
					} else if(pixelAtual == 0xFFFFD800) {
						// Coin
						Coin c = new Coin(xx*16, yy*16, 16, 16, 0, Entity.COIN);
						Game.entities.add(c);
						Player.maxCoins++;
